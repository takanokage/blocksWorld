...
from VehicleProfile import Rectangle, Circle, Square, Triangle, Sedan, SUV1, SUV2, Wagon, train, Bicycle
...
if __name__ == "__main__":
    ...
    NumberOfImages = 0                              # the number of images you want [0-100000]
    ...
    for idx in range(NumberOfImages + 1):
        ...
        Parameters = ['False', 'False',random.choice(range(5, 20)), random.choice(range(0,90,5) )]
